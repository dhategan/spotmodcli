...
class Init extends command_1.Command {
    async run() {
        ...
        await fs_1.promises.writeFile(destinationManifestPath, JSON.stringify(manifestJson));
        ...
        await fs_1.promises.writeFile(destinationPackagePath, JSON.stringify(packageJson));
