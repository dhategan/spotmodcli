...
Update.description = `Update a Spotfire Mods project to another API version. After this it might be necesary to revise the mod source code so that it's aligned with the new api version.
`;
Update.args = [
    { name: 'path' }
];
